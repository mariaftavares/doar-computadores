...
exports.up = function (knex) {
  return knex.schema.alterTable('devices', (table) => {
    ...
    table.foreign('donation_id').references('donations.id').onDelete('CASCADE').onUpdate('CASCADE')
  })
}
...
exports.down = function (knex) {
  return knex.schema.alterTable('devices', (table) => {
    ...
    table.foreign('donations_iddonation').references('donations.id').onDelete('CASCADE').onUpdate('CASCADE')
  })
}
